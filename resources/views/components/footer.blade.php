    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-1">
                    <li><a href="{{ route('dashboard', ['username' => $username ?? 'Guest']) }}" class="text-gray-600 hover:text-blue-600">Dashboard</a></li>
                    <li><a href="{{ route('pengelolaan', ['username' => $username ?? 'Guest']) }}" class="text-gray-600 hover:text-blue-600">Daftar Buku</a></li>
                    <li><a href="{{ route('profile', ['username' => $username ?? 'Guest']) }}" class="text-gray-600 hover:text-blue-600">Profil</a></li>
                </ul>
            </div>
